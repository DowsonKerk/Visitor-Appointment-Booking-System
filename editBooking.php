		...
		<div class="row">
			<div class="form-group row col-md-5 p-3 mx-auto"></br>								
                ...
                <?php 
		 			...
		 			else echo "<h5>Click the list row to view Booking slot time!</h5>";  ?>
                </div>
         		<br/>
					...
					<table id="example" class="table table-bordered table-hover">
						...
						<?php
							for($i = 0; $i < mysqli_num_rows($Result); $i++)
							{
								...
								echo "<tr class = \"Row\"";
								if($_GET['Id'] == "")
								echo "onclick = \"location = 'addBooking.php?Id=".$RecRow['bookedSlotId']."'\"";
								else echo  "onclick = \"location = 'viewBooking.php?Id=".$RecRow['bookedSlotId']."'\"";
								echo ">";
