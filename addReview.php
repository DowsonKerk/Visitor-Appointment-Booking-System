    	...
    	<div class="card">
    		...
    		<div class="card-body">
    			<div class="row">
    				...
    				<div class="col-sm-4 text-center">
    					<h3 class="mt-4 mb-3">Add Review Here</h3>
    	...
    	<div class="modal-content">
	      	...
	      	<div class="modal-body">
                ...
                <div class="form-group">
	        		<input type="text" name="user_id" id="user_id" class="form-control" value="<?php echo $_SESSION['user']['id']; ?>" hidden>
	        	</div>
	        	<div class="form-group">
	        		<input type="text" name="user_name" id="user_name" class="form-control" value="<?php echo $_SESSION['user']['username']; ?>" readonly="readonly"/>
	        	</div>
	        	<div class="form-group">
